                  ...
                  <SpecificationsContainer>
                    ...
                    <SpecsListWrapper>
                      <ul style={{ listStyle: "none", padding: "0px" }}>
                        <SpecsList>
                          <strong>Screen size:</strong> 55 inches
                        </SpecsList>
                        <SpecsList>
                          <strong>Resolution:</strong> 4K HDR
                        </SpecsList>
                        <SpecsList>
                          <strong>Technology:</strong> ULED
                        </SpecsList>
                        <SpecsList>
                          <strong>Bluetooth connection:</strong> Yes
                        </SpecsList>
                        <SpecsList>
                          <strong>USB inputs:</strong> 2
                        </SpecsList>
                      </ul>
                    </SpecsListWrapper>
                  </SpecificationsContainer>
