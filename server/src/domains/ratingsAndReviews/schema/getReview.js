...
const getReviews = {
	schema: {
		description:
			'This API is to get all reviews and ratings for the product, all abusive reviews, all removed reviews, all published reviews with sortby and pagination feature',
...
const getMyReviews = {
	schema: {
		description:
			'This API is to get all reviews and ratings by the author. All abusive reviews, all removed reviews, all published reviews with sortby and pagination feature',
		tags: ['For Client'],
		params: {
			type: 'object',
			properties: {
