...
const ReviewBlock = ({ review }) => {
	const { id, helpful_count, description, title, verifiedPurchase, rating, modified_date,imageLink, sentiment } = review;
	...
	return rating !== 0 || title || description ? (
      ...
      {imageLink.length !== 0 && <ImageViewer links={imageLink} />}
			<Content>
